...
public:
	...
	struct FWeaponReloadData                           FinalReloadData;                                          // 0x1270(0x0020) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FWeaponReloadData                           NewVar_1;                                                 // 0x1290(0x0020) (Edit, BlueprintVisible, DisableEditOnInstance)
