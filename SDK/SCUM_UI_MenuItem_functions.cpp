...
void UUI_MenuItem_C::SetItemClassAndIcon(class UClass* Item, class UTexture2D* Icon)
{
	...
	UUI_MenuItem_C_SetItemClassAndIcon_Params fn_params;
	fn_params.Item = Item;
	fn_params.Icon = Icon;
...
void UUI_MenuItem_C::BndEvt__Button_0_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature()
{
	...
	UUI_MenuItem_C_BndEvt__Button_0_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature_Params fn_params;
...
void UUI_MenuItem_C::OnSynchronizeProperties()
{
	...
	UUI_MenuItem_C_OnSynchronizeProperties_Params fn_params;
...
void UUI_MenuItem_C::ExecuteUbergraph_UI_MenuItem(int EntryPoint)
{
	...
	UUI_MenuItem_C_ExecuteUbergraph_UI_MenuItem_Params fn_params;
