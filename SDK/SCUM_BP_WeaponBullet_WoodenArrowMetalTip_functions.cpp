...
void ABP_WeaponBullet_WoodenArrowMetalTip_C::UserConstructionScript()
{
	...
	ABP_WeaponBullet_WoodenArrowMetalTip_C_UserConstructionScript_Params fn_params;
...
void ABP_WeaponBullet_WoodenArrowMetalTip_C::ReceiveBeginPlay()
{
	...
	ABP_WeaponBullet_WoodenArrowMetalTip_C_ReceiveBeginPlay_Params fn_params;
...
void ABP_WeaponBullet_WoodenArrowMetalTip_C::ExecuteUbergraph_BP_WeaponBullet_WoodenArrowMetalTip(int EntryPoint)
{
	...
	ABP_WeaponBullet_WoodenArrowMetalTip_C_ExecuteUbergraph_BP_WeaponBullet_WoodenArrowMetalTip_Params fn_params;
