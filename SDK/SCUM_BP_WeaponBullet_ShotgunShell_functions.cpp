...
void ABP_WeaponBullet_ShotgunShell_C::UserConstructionScript()
{
	...
	ABP_WeaponBullet_ShotgunShell_C_UserConstructionScript_Params fn_params;
...
void ABP_WeaponBullet_ShotgunShell_C::ReceiveBeginPlay()
{
	...
	ABP_WeaponBullet_ShotgunShell_C_ReceiveBeginPlay_Params fn_params;
...
void ABP_WeaponBullet_ShotgunShell_C::ExecuteUbergraph_BP_WeaponBullet_ShotgunShell(int EntryPoint)
{
	...
	ABP_WeaponBullet_ShotgunShell_C_ExecuteUbergraph_BP_WeaponBullet_ShotgunShell_Params fn_params;
