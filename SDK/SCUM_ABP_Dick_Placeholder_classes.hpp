...
public:
	...
	bool                                               EnabledIK;                                                // 0x0AC0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0AC1(0x0003) MISSED OFFSET
	struct FVector                                     _targetIK;                                                // 0x0AC4(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
