...
struct FLinearColor UUI_CTFMiniStatsWidget_C::GetColor()
{
	...
	UUI_CTFMiniStatsWidget_C_GetColor_Params fn_params;
...
void UUI_CTFMiniStatsWidget_C::UpdateStats()
{
	...
	UUI_CTFMiniStatsWidget_C_UpdateStats_Params fn_params;
...
void UUI_CTFMiniStatsWidget_C::FillLabels()
{
	...
	UUI_CTFMiniStatsWidget_C_FillLabels_Params fn_params;
...
void UUI_CTFMiniStatsWidget_C::ExecuteUbergraph_UI_CTFMiniStatsWidget(int EntryPoint)
{
	...
	UUI_CTFMiniStatsWidget_C_ExecuteUbergraph_UI_CTFMiniStatsWidget_Params fn_params;
