...
// BlueprintGeneratedClass BP_Weapon_98k_KarabinerTest.BP_Weapon_98k_KarabinerTest_C
// 0x0050 (0x13A0 - 0x1350)
class ABP_Weapon_98k_KarabinerTest_C : public AWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Weapon_98k_KarabinerTest.BP_Weapon_98k_KarabinerTest_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Weapon_98k_KarabinerTest(int EntryPoint);
};
