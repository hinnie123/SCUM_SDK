...
{
public:
	TArray<struct FLadderMarker>                       LadderMarkers;                                            // 0x0700(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<struct FWindowMarker>                       WindowMarkers;                                            // 0x0710(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
